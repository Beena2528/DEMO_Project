package com.avatrade.myvip.utility;

import com.avatrade.myvip.drivermanager.ManageDriver;
...
//*************************** Action Methods ***************************************//
    ...
    public void holdAndPress(WebElement iframe) {
        Actions action = new Actions(driver);
        iframe = driver.findElement((By) iframe);
        action.moveToElement(iframe).moveByOffset(-550, +70).build().perform();
       // action.clickAndHold(iframe).build().perform();
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/avatrade/myvip/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/avatrade/myvip/screenshots/" + screenshotName + dateName + ".png";
